...
def exp_sphere_radius(pos=4):
    scene = scenes.OneSphere()
    if config['op_dim'] == 1:
        scene.set_position(sparams.measured_sphere_pos[pos][0], sparams.measured_sphere_pos[pos][1], sparams.measured_sphere_pos[pos][2])
    elif config['op_dim'] == 2:
...
def exp_sphere_plane_mat(pos=3):
    scene = scenes.SpherePlane()
    scene.set_sphere_position(sparams.measured_sphere_plane_pos[pos][0], sparams.measured_sphere_plane_pos[pos][1], sparams.measured_sphere_plane_pos[pos][2])
    scene.set_sphere_radius(0.02)
    return scene
...
def exp_torus_material(pos=4):
    scene = scenes.OneTorus()
    scene.set_position(sparams.measured_torus_pos[pos][0], sparams.measured_torus_pos[pos][1], sparams.measured_torus_pos[pos][2]-0.01)
    return scene
